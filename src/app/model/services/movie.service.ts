...
export class MovieService {
  ...
  constructor() {
    ...
    m1.year = 2023;
    m1.imageUrl = 'assets/img/spiderman.jpg';
    ...
    m2.imageUrl = 'assets/img/x.jpg';
    let m3: Movie = new Movie('No Hard Feelings', 1, '16');
    m3.year = 2023;
    m3.imageUrl = 'assets/img/no-hard-feelings.jpg';
